...
Recent open source contributions include a [multi-turn LLM evaluation](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/makemesay) in the UK government's Inspect framework, and my own lambda and LLM-based [running coach](https://running.bendixon.net/). A while ago my MSc dissertation was published as a NeurIPS [workshop paper](https://www.climatechange.ai/papers/neurips2022/58). 